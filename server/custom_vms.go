...
import (
	...
	"github.com/lasthyphen/dijets-drover/pkg/color"
	"github.com/lasthyphen/dijets-drover/rpcpb"
	"github.com/lasthyphen/dijets-drover/utils"
...
func (lc *localNetwork) installCustomVMs(ctx context.Context) error {
	...
	baseWallet, djtxAssetID, testKeyAddr, err := lc.setupWallet(ctx, httpRPCEp)
	if err != nil {
		return err
	}
...
func (lc *localNetwork) setupWallet(ctx context.Context, httpRPCEp string) (baseWallet *refreshableWallet, djtxAssetID ids.ID, testKeyAddr ids.ShortID, err error) {
