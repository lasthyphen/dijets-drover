...
```sh
git clone https://github.com/lasthyphen/dijets-drover.git
```
...
Download from https://github.com/lasthyphen/dijets-drover/releases:

```bash
# or install
cd ${HOME}/go/src/github.com/lasthyphen/dijets-drover
...
See [here](https://docs.djtx.network/build/references/avalanchego-config-flags) for the reference of supported flags.
